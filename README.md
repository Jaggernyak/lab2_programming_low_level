## 📖 КОНСОЛЬНЫЙ КАЛЬКУЛЯТОР ПО РАЗНЫМ ЗАДАЧАМ
...
3. На выбор вам 11 задач,пишете в консоль номер одной из задач.
4. Вводите (символы/целые чила/строки/n элемент массива) в консоль соответсвии от выбранной задачи или что требуется ввести по условию этой задачи.
5. Консоль выводит результат вашей задачи и завершает работу.
